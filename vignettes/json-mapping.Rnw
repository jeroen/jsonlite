...
Most of the calls return a lot of data, and in most examples below, no output is printed. The user is encouraged to replaced the examples in R and inspect the output manually. 
