...
The previous section described a mapping between \JSON data and R classes.  This section takes a higher level view and we outline some best practices for designing structures that can be used across platforms.

- Interpreting, processing data
- Describing, documenting, schema.
