...
```
 [1] "PS: Clustering whiskies http://t.co/xAAUb3OiwY #rstats"                                              
 [2] "SAS on the road http://t.co/UvnyKq0KAD #rstats"                                                      
 [3] "Shoutout for Atlassian http://t.co/FQ4KuuPVaX #rstats"                                               
 [4] "Comparing ifelse with C++ for loop with ifs http://t.co/aSdfdcqzVG #rstats"                          
 [5] "Scratching that itch from ifelse http://t.co/6T5Qbd8ifD #rstats"                                     
 [6] "Baseball: Probability of winning conditional on runs, hits, walks and errors http://t.co/QsDWEAVxsq "
 [7] "Win Books and T-shirts in Our DataScience.LA Meetup Raffles, Powered by R and dplyr! http://t.co/QPk"
 [8] "The Importance of ‘Janitorial Work’ in Research http://t.co/2ue94S8AYa #rstats"                      
 [9] "littler is faster at doing nothing! http://t.co/7aFnAmQtGV #rstats"                                  
[10] "Using R to simulate the finances of public sector pension funds http://t.co/xc9BIuVq3Y #rstats"      
```
