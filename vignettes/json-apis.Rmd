...
```
 [1] "petrbouchal   : scale_colour_manual fails when elements of named matrix are passed to values"   
 [2] "smirarab      : stat_ecdf plots extra points"                                                   
 [3] "dorvak        : Suggestion: Geom replace infix operator"                                        
 [4] "rpruim        : documentation of fun.data (in stat_summary) incorrect?"                         
 [5] "ttuggle       : Memory overflow with scale_x_discrete()"                                        
 [6] "pengyu        : Added ..Name to each prototype so that str.proto() can show the names correctly"
 [7] "pharaveej     : ggplot - geom_step error"                                                       
 [8] "noamross      : New theme option to put panel/grid on top of data"                              
 [9] "krlmlr        : geom_boxplot with continuous x and without group aesthetics"                    
[10] "lccanon       : rqss in stat_quantile ignore the quantile with large number of values"          
[11] "bergsmat      : Geom not exported?"                                                             
[12] "iagomosqueira : size in geom_point using variable with all but 1 as NAs"                        
[13] "xsaintmleux   : allow ggplot_build to return an additional value: the processed data as ..."    
[14] "mkcor         : Edit warning message to reflect intuitive use"                                  
[15] "tsibley       : Rebased and redocumented version of PR #744"                                    
[16] "BrianDiggs    : sqrt_trans, scale limit expansion, and missing breaks"                          
[17] "marvel64      : Documentation for geom_boxplot"                                                 
[18] "blaquans      : Would it be possible to add notes to a ggplot graph ?"                          
[19] "jiho          : New theme_void(), completely empty"                                             
[20] "veraanadi     : Add new function geom_curve"                                                    
[21] "lionelgit     : Facet titles"                                                                   
[22] "kent37        : Error in stat_density example text"                                             
[23] "tonytonov     : geom_violin throws error on data with zero variance"                            
[24] "cboettig      : scales=\"free\" on facet_grid no longer has any effect on `y` axis within rows" 
[25] "baptiste      : check.class argument to ggsave"                                                 
[26] "lionelgit     : Coord expand"                                                                   
[27] "croach        : Fix for bad URL in qplot docs"                                                  
[28] "richierocks   : geom_hex fails when filled with a continuous variable"                          
[29] "wibeasley     : Setting variable to NULL within `aes_string()`"                                 
[30] "tonytonov     : Throw error if lower > upper in cont scales. Fixes #906"                        
```
...
tweets <- fromJSON(json, unicode = TRUE)
substring(tweets$text, 1, 100)
```

```
 [1] "Periodic matrix model for annual plant demography http://t.co/8CzhOVfU0K #rstats"                    
 [2] "Forecasts After Marina's Turbulence http://t.co/UcWhUitkWs #rstats"                                  
 [3] "Pander/Pandoc for Pretty Conversion on the R Studio Server http://t.co/ZKNJQnQ7mY #rstats"           
 [4] "Five Reasons to Teach Elementary Statistics With R:  #1 http://t.co/pkDZ5GFUmI #rstats"              
 [5] "Five Reasons to Teach Elementary Statistics With R:  #2 http://t.co/omYRNmUNCi #rstats"              
 [6] "Five Reasons to Teach Elementary Statistics With R:  #3 http://t.co/8l4QYE9Vq6 #rstats"              
 [7] "New Wine in an Old Bottle:  R Markdown v2 and R Studio on the Cent OS Server http://t.co/8ZYzArydRn "
 [8] "Age-Length Keys in FSA http://t.co/Vtm3BHkCDm #rstats"                                               
 [9] "Post 0: Getting Started with R http://t.co/cbqvYbxf6b #rstats"                                       
[10] "pbapply() http://t.co/PB5hzNhveg #rstats"                                                            
```
